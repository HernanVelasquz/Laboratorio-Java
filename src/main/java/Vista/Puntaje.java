...
public class Puntaje extends javax.swing.JFrame {
    ArrayList<Entidades.Puntaje> scoreList = null;
    PuntajeDAO pdao = null;
    ...
    public Puntaje() {
        ...
        for (int i = 0; i < scoreList.size(); i++) {
            matriz[i][0] = (i + 1) + "";
            matriz[i][1] = scoreList.get(i).getNombre_jugador();
            matriz[i][2] = scoreList.get(i).getJugador_puntaje() + "";
        }
