...
public class Score {
    ArrayList<org.sofka.model.Score> scoreList = null;
    ScoreDAO pdao = null;
    ...
    public Score() {
        ...
        pdao = new ScoreDAO();
        scoreList = pdao.getPuntaje();

        String[][] matriz = new String[scoreList.size()][3];
        for (int i = 0; i < scoreList.size(); i++) {
            matriz[i][0] = (i + 1) + "";
            matriz[i][1] = scoreList.get(i).getNick_player();
            matriz[i][2] = scoreList.get(i).getScore_player() + "";
        }
